    ...
    `:H`
      ...
      >
        ...
        <div class="schedule-grid ${this._isCompactView?"compact":""}">
          ${fe($e,e=>e,e=>{const t=this._getParsedBlocks(e);if(!t||0===t.length)return H``;const i=this._copiedSchedule?.weekday===e;return H`
